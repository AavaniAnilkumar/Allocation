...
import { Button, TableContainer, Table, TableHead, TableBody, TableRow, TableCell, TextField, Modal, Paper, Container, Typography, Grid, Radio, FormControlLabel } from '@mui/material';
  ...
  return (
    <div className="user-container" style={{ textAlign: 'center' }}>
      ...
      <FormControlLabel
        control={
          <Radio
            checked={formData.is_active === 'true'} // Assuming your is_active value is a string
      ...
      <FormControlLabel
        control={
          <Radio
            checked={formData.is_staff === 'true'} // Assuming your is_staff value is a string
