...
class AdminView(APIView):                               #(to create Admin  )
...
class AllocationUpdate(APIView):                                                            #Add allocation 
    queryset = Allocation.objects.all()
    serializer_class = AllocationSerializer
    authentication_classes=[JWTAuthentication]
    permission_classes=[IsAuthenticated,IsAdminUser | CustomDjangoModelPermissions]
            ...
            for employee in employees:
                ...
                employee_data = {
                    'employee': {
                        ...
                        'is_active':employee.is_active  # Replace with actual employee name field
                    },
